...
if __name__ == "__main__":
    ...
    #--------------------------------
        ...
        low_medium_rank_convs = {'features.5', 'features.7'}
        medium_rank_convs = {'features.10', 'features.12', 'features.14'}
        high_rank_convs = {'features.17', 'features.19', 'features.21'}
        ...
        for layer in target_layers:
                ...
                if 'classifier' in layer:
                        ...
                        if layer in low_rank_convs:
                                rank = 64
                        elif layer in low_medium_rank_convs:
                                rank = 128
                        elif layer in medium_rank_convs:
                                rank = 256
                        elif layer in high_rank_convs:
                                rank = features_cv_dim
                        else:
                                rank = 100
