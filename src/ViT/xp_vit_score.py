...
if __name__ == "__main__":
        ...
        plots_path = Path.cwd()/'temp_plots/conf/best_compared'


        scores_file = Path('/home/claranunesbarrancos/repos/XAI/src/mobilenet/scores/temp_score_cifar100_best')
        ...
        # 'features.17.conv.0.0', 'features.17.conv.1.0', 
        # 'features.17.conv.2',
