...
from torchvision.models import Wide_ResNet50_2_Weights as pre_train_weights
...
if __name__ == "__main__":
    ...
    tune_dir = Path.cwd()/'../data/wide_resnet50_2_cifar100'
    ...
    nn = wide_resnet50_2(weights=pre_train_weights.DEFAULT)
