...
from corevectors.config_cifar100_vgg16 import *

drill_path = Path('/srv/newpenny/XAI/generated_data/TPAMI/drillers/CIFAR100_VGG16')
drill_name = 'classifier'
                                                
phs_path = Path('/srv/newpenny/XAI/generated_data/peepholes/CIFAR100_vgg16')
phs_name = 'peepholes'
                                                
tune_storage_path = Path('/srv/newpenny/XAI/generated_data/tuning/CIFAR100_vgg16')
