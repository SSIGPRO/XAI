...
#     print(f"Using {device} device")
    ...
    cvs_path = Path('/srv/newpenny/XAI/Peephole-Analysis/corevectors') #Path.cwd()/'../data/corevectors'
    cvs_name = 'corevectors'

    drill_path = Path('/srv/newpenny/XAI/Peephole-Analysis/drillers_on_class') #Path.cwd()/'../data/drillers'
    drill_name = 'classifier'

    phs_path = Path('/srv/newpenny/XAI/Peephole-Analysis/peepholes_on_class') #Path.cwd()/'../data/peepholes'
    phs_name = 'peepholes'
    ...
    #--------------------------------
    #dss = ds._dss
    print(len(ds_OOD._dss['train']), len(ds_OOD._dss['val']), len(ds_OOD._dss['test'])) 
    dss = random_subsampling(ds_OOD._dss, 0.2)
    dss = {
        #     'train': dss['train'],
        #     'val': dss['val'],
            'test': dss['test'],
