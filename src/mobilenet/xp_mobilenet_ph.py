...
from peepholelib.coreVectors.dimReduction.svds import linear_svd_projection as svd_Linear
from peepholelib.coreVectors.dimReduction.svds import conv2d_toeplitz_svd_projection as svd_Conv2D
