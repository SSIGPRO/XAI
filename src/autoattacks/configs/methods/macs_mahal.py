### Estimating the covariance matrix given a number of clusters that is much higher than the number of classes doesn't make any sense
...
from peepholelib.peepholes.parsers.peepholes_parsers import mahalanobis_parser as peepholes_parser
from peepholelib.scores.ecdf import ECDF as ecdf

from configs.common import *

phs_name = 'peepholes_mahalanobis'
