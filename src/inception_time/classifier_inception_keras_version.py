...
class Classifier_INCEPTION:
    ...
    def _inception_module(
        ...
        x = keras.layers.Concatenate(axis=2)(
            conv_list
        )
    ...
    def fit(
        ...
        # ========================================================
        # Calculate final test accuracy manually
        # ========================================================
        ...
        print(
            f"Training time : {duration:.2f} seconds"
        )
    ...
    def predict(
        ...
        # IMPORTANT:
        # best_model.weights.h5 contains weights only.
        # Therefore, use load_weights(), not load_model().
        ...
        if return_df_metrics:
            ...
            # y_true can be one-hot or integer labels.
